...
const goats = {
	...
	videoReward: "GoatCelebration/1.mp4",
	questions: [
		{
	...
	videoReward: "GoatCelebration/2.mp4",
	questions: [
		{
	...
	videoReward: "GoatCelebration/6.mp4",
	questions: [
		{
	...
	videoReward: "GoatCelebration/3.mp4",
	questions: [
		{
	...
	videoReward: "GoatCelebration/4.mp4",
	questions: [
		{
	...
	videoReward: "GoatCelebration/5.mp4",
	questions: [
		{
...
function renderQuestion() {
	...
	quizData.options.forEach( (opt, Index) => {
		...
		/*  displays images as options if available for or shows text instead */
...
function handleAnswer(choice, btn) {
	...
	if(choice === correctAnswer) {
		...
		//  after 800ms toogles background color bawck to default 
		setTimeout( ()=> {
...
function showVideoReward() {
	...
	if(vidReward === false) { 
		videoWrapper.textContent = "video not available";
